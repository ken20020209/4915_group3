...
CREATE TABLE `delivery_request` (
  ...
  `vehicle_ID` int DEFAULT NULL COMMENT 'The ID to identify each vehicle\\n0000000000-9999999999\\n\\n',
  ...
  KEY `Delivery_Request_v_ID_fk_idx` (`vehicle_ID`),
...
INSERT INTO `delivery_request` VALUES (1,1,1,3,4,2000,'2023-03-16','2023-03-20','12:34:56','10:04:32',NULL),(2,2,2,4,5,2000,'2023-04-23','2023-04-27','11:54:20','12:06:49',NULL),(3,3,3,2,7,2100,'2023-02-28','2023-03-05','14:52:11','15:07:23',NULL),(4,4,4,1,4,2000,'2023-03-06','2023-03-17','16:43:22','17:23:45',NULL),(5,3,2,5,5,2000,'2023-03-05','2023-04-20','15:00:00','15:00:00',NULL),(6,3,1,6,5,2000,'2023-05-04','2023-08-20','15:00:00','16:00:00',NULL),(7,3,2,2,7,2000,'2023-05-01','2023-05-20','15:00:00','15:00:00',NULL),(8,3,6,1,99,2000,'2023-07-07','2023-06-20',NULL,NULL,NULL),(9,3,6,1,99,2000,'2023-07-07','2023-06-20',NULL,NULL,NULL),(10,3,6,2,88,2000,'2023-07-07','2023-06-13',NULL,NULL,NULL),(11,3,6,1,99,2000,'2023-07-09','2023-06-20',NULL,NULL,NULL),(12,3,6,1,99,2000,'2023-07-09','2023-06-20',NULL,NULL,NULL),(13,3,6,1,100,2000,'2023-07-09','2023-07-09',NULL,NULL,NULL),(14,3,6,2,88,2000,'2023-07-09','2023-06-13',NULL,NULL,NULL),(15,3,7,1,100,2000,'2023-07-09','2023-07-09',NULL,NULL,NULL),(16,3,1,1,100,2100,'2023-07-09','2023-07-09',NULL,NULL,NULL),(19,2,8,3,56,2100,'2023-07-09','2023-07-09',NULL,NULL,19);
...
CREATE TABLE `invoice` (
  ...
  CONSTRAINT `pur` FOREIGN KEY (`purchase_order_ID`) REFERENCES `purchasers_request` (`purchasers_request_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `invoice` VALUES (1,3,'2023-04-25','2023-04-19','4100'),(2,3,'2023-03-17','2023-03-11','4100'),(3,3,'2023-02-11','2023-02-01','4100'),(4,3,'2023-04-11','2023-04-01','4100'),(5,3,'2023-07-09','2023-07-09','4000'),(8,19,'2023-07-09','2023-07-09','4000');
...
INSERT INTO `purchasers_request` VALUES (3,1,1,1,99,1,1200,'2023-06-13','2023-06-20','qw'),(4,1,1,2,99,2,1200,'2023-06-13','2023-06-13',''),(5,1,1,1,9999,2,1200,'2023-06-13','2023-06-13',''),(6,1,1,2,88,3,1200,'2023-06-13','2023-06-13',''),(7,1,1,1,123,4,1200,'2023-06-13','2023-06-13',''),(11,1,1,1,50,0,1200,'2023-07-07','2023-07-07',''),(12,2,1,1,12,0,1000,'2023-07-09','2023-07-09',''),(13,1,1,1,100,0,1200,'2023-07-09','2023-07-09',''),(14,1,1,1,100,0,1000,'2023-07-09','2023-07-09','sgsgsh'),(15,5,2,2,900,1,1000,'2023-07-09','2023-07-09',''),(16,2,1,1,999,0,1200,'2023-07-09','2023-07-09',''),(17,2,1,1,100,0,1200,'2023-07-09','2023-07-09',''),(19,5,3,3,56,0,1200,'2023-07-09','2023-07-09','');
...
INSERT INTO `restaurant` VALUES (1,'Good',1,'1','12345678',1),(2,'God',7,'2','98765432',11),(3,'Asia-Res',8,'2','67439867',12);
...
INSERT INTO `restaurant_stock_item` VALUES (1,1,350,'Changeeeeeeeeee',NULL,'123'),(2,2,600,'',NULL,'124'),(3,3,318,NULL,NULL,'125');
...
INSERT INTO `role` VALUES (1,'Restaurant manager',NULL),(2,'HR manager',NULL),(3,'Category manager',NULL),(4,'Purchase manager',NULL),(5,'Accounting manager',NULL),(21,'warehouse manager',NULL),(24,'admin',NULL);
...
INSERT INTO `status` VALUES (1000,'wait to process','request'),(1100,'error process','request'),(1200,'complete process','request'),(2000,'wait to delivery','delivery request'),(2100,'delivered','delivery request'),(3000,'wait to despatch','warehouse'),(3100,'complete despatch','warehouse'),(3200,'wait to sign','warehouse'),(4000,'wait to process','PO'),(4100,'complete','PO');
...
INSERT INTO `user` VALUES (1,'Sam','Yau',1,'kenrest1','123123','m','12345678','sam@gmail.com'),(2,'Helen','Chung',21,'helenware1','123123','f','78536570','helen@gmail.com'),(3,'Ken','Leung',2,'kenHR','123321','m','54327865','ken@gmail.com'),(4,'Oscar','Chu',3,'oscar456cate','098765','m','74358986','oscar@gmail.com'),(5,'Yuksen','Lam',24,'sing654Admin','567890','m','96436789','yuksen@gmail.com'),(6,'Helen','Chung',21,'helenware2','123123','f','55555555','helen2@gmail.com'),(7,'Helen','Chung',21,'helenware3','123123','f','11111111','helen3@gmail.com'),(8,'Helen','Chung',4,'HelenAPur','123123','f','54123654','accountingHelen@gmail.com'),(9,'Helen','Chung',5,'HelenbAcco','123123','f','54123654','accountingHelen@gmail.com'),(10,'Helen','Chung',21,'Helenware4','123123','f','54123654','accountingHelen@gmail.com'),(11,'Helen','Chung',1,'kenrest2','123123','f','54123654','accountingHelen@gmail.com'),(12,'Helen','Chung',1,'kenrest3','123123','f','54123654','accountingHelen@gmail.com');
...
CREATE TABLE `warehouse` (
  ...
  KEY `Warehouse_handler_id_fk_idx` (`handler_id`),
  CONSTRAINT `Warehouse_address_id_fk` FOREIGN KEY (`address_id`) REFERENCES `address` (`address_id`),
  CONSTRAINT `Warehouse_handler_id_fk` FOREIGN KEY (`handler_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `warehouse` VALUES (1,'topFreezer',3,'11111111',2),(2,'bottomFreezer',4,'22222222',6),(3,'drinkHouse',1,'33333333',7),(4,'seasoningHouse',2,'44444444',10);
...
INSERT INTO `warehouse_item` VALUES (1,1,8800,0),(1,2,0,0),(1,3,2,0),(2,1,5560,0),(2,4,6666,0),(2,5,6666,0),(3,6,6666,0),(4,3,9831,0),(4,7,6666,0);
...
INSERT INTO `warehousedispatchinstruction` VALUES (2,2,2,NULL,4,3000,4),(3,3,3,NULL,6,3000,5),(4,4,4,NULL,7,3000,6),(8,1,NULL,'kryptonTextBoxRemark',1,3000,3),(9,1,NULL,'kryptonTextBoxRemark',1,3000,7),(10,1,NULL,'kryptonTextBoxRemark',1,3000,7);
...
-- Dump completed on 2023-07-09 21:46:28
