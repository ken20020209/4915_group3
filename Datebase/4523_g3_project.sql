...
CREATE TABLE `blanket_release` (
  `release_ID` char(10) NOT NULL COMMENT 'The ID to identify the Blanket release\n0000000000-9999999999\n\n',
  `header_ID` char(10) NOT NULL COMMENT 'The ID to identify the header\n0000000000-9999999999\n\n',
  ...
  `price_break_ID` char(10) NOT NULL COMMENT 'The ID to identify the price break\n0000000000-9999999999\n\n',
  `amount` int NOT NULL COMMENT 'The amount of Blanket release\n\n\n\n',
  `shipment_ID` char(10) NOT NULL COMMENT 'The ID to identify the shipment\n0000000000-9999999999\n\n',
...
CREATE TABLE `bpa_header` (
  `header_ID` char(10) NOT NULL COMMENT 'The ID to identify the header of BPA\n0000000000-9999999999\n\n',
  ...
  `supplier_ID` char(10) NOT NULL COMMENT 'The ID to identify the BPA supplier\n0000000000-9999999999\n\n',
  `buyer_ID` char(10) NOT NULL COMMENT 'The ID to identify the BPA buyer\n0000000000-9999999999\n\n',
...
CREATE TABLE `bpa_lines` (
  `lines_ID` char(10) NOT NULL COMMENT 'The ID to identify the BPA line \n0000000000-9999999999\n\n',
  `header_ID` char(10) NOT NULL COMMENT 'The ID to identify the header\n0000000000-9999999999\n\n',
  `item_ID` char(10) NOT NULL COMMENT 'The ID to identify the BPA item\n0000000000-9999999999\n\n',
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cpa` (
  `CPA_ID` char(10) NOT NULL COMMENT 'The ID of CPA\n0000000000-9999999999\n\n',
  `create_date` date NOT NULL COMMENT 'the create date of CPA\nDD/MM/YYYY\n\n',
  `effective_date` date NOT NULL COMMENT 'The effective date of CPA\nDD/MM/YYYY\n\n',
  `supplier_ID` char(10) NOT NULL COMMENT 'The ID of the supplier to identify different suppliers\n0000000000-9999999999\n\n',
  `buyer_ID` char(10) NOT NULL COMMENT 'The ID of the buyers to identify different suppliers \n0000000000-9999999999\n\n',
  `terms` varchar(30) NOT NULL COMMENT 'The terms of CPA.\n\n\n\n',
  `condition` varchar(30) NOT NULL COMMENT 'The condition of CPA.\n\n\n\n',
  `item_ID` char(10) NOT NULL COMMENT 'The ID of the item\n0000000000-9999999999\n\n',
  PRIMARY KEY (`CPA_ID`),
...
CREATE TABLE `delivery_request` (
  `delivery_request_ID` char(10) NOT NULL COMMENT 'The ID to identify each delivery request\n0000000000-9999999999\n\n',
  `delivery_address_ID` char(10) NOT NULL COMMENT 'The ID to identify each delivery address\n0000000000-9999999999\n\n',
  `receive_address_ID` char(10) NOT NULL COMMENT 'The ID to identify each receive address\n0000000000-9999999999\n\n',
  `item_ID` char(10) NOT NULL COMMENT 'The ID to identify each \n0000000000-9999999999\n\n',
  `quantity` int NOT NULL COMMENT 'The quantity of each delivery item\n\n\n\n',
  `status_ID` char(10) NOT NULL COMMENT 'The Status of delivery\n0000000000-9999999999\n\n',
  ...
  `vehicle_ID` char(10) NOT NULL COMMENT 'The ID to identify each vehicle\n0000000000-9999999999\n\n',
...
CREATE TABLE `delivery_request_handler` (
  `ID` char(10) NOT NULL COMMENT '0000000000-9999999999',
  `delivery_request_ID` char(10) NOT NULL COMMENT 'The ID to identify each delivery request\n0000000000-9999999999\n\n',
  `delivery_staff_ID` char(10) NOT NULL COMMENT 'The ID to identify each Delivery staff\n0000000000-9999999999\n\n',
  PRIMARY KEY (`ID`),
...
CREATE TABLE `department` (
  `dept_id` char(10) NOT NULL COMMENT 'The ID to identify each department\n0000000000-9999999999\n\n',
...
CREATE TABLE `department_role` (
  `dept_id` char(10) NOT NULL COMMENT 'The ID to identify the department\n0000000000-9999999999\n\n',
  `role_id` char(10) NOT NULL COMMENT 'The ID to identify the role\n0000000000-9999999999\n\n',
...
CREATE TABLE `food_beverage` (
  `Food_Beverage_ID` char(10) NOT NULL COMMENT 'The ID of the\nfood and beverage \n0000000000-9999999999\n\n',
  `category_ID` char(10) NOT NULL COMMENT 'The ID of the category\n0000000000-9999999999\n\n',
...
CREATE TABLE `invoice` (
  `Invoice_ID` char(10) NOT NULL COMMENT 'The ID to identify different invoice\n0000000000-9999999999\n\n',
  `purchase_order_ID` char(10) NOT NULL COMMENT 'The ID to identify the purchase order\nCCCCBBYYYYMMDDSSSS\n\nCCCC - Company Code\nBB - Branch\nYYYY - Year\nMM - Month\nDD - Day\nSSSS - Sequence number per day\n\n',
...
CREATE TABLE `item` (
  ...
  `category_ID` char(10) NOT NULL COMMENT 'The ID that identify the category\n0000000000-9999999999\n\n',
  `partner_brand_ID` char(10) NOT NULL COMMENT 'The ID of the partner’s brand\n0000000000-9999999999\n\n',
  PRIMARY KEY (`item_ID`),
...
CREATE TABLE `notify_message` (
  `notify_message_id` char(10) NOT NULL COMMENT 'The ID to identify different notify_message\n0000000000-9999999999\n\n',
  `notify_rule_id` char(10) NOT NULL COMMENT 'The ID to identify the purchase order\n0000000000-9999999999\n\n',
...
CREATE TABLE `notify_rule` (
  `notify_rule_id` char(10) NOT NULL COMMENT 'The ID to identify different rule\n0000000000-9999999999\n\n',
  `user_id` char(10) NOT NULL COMMENT 'The ID to identify the purchase order\n0000000000-9999999999\n\n\n',
...
CREATE TABLE `partner_brand` (
  `partner_brand_ID` char(10) NOT NULL COMMENT 'The ID to identify  the partner brand\n0000000000-9999999999\n\n',
...
CREATE TABLE `partner_brand_restaurant` (
  `partner_brand_ID` char(10) NOT NULL COMMENT 'The ID to identify the partner branch\n0000000000-9999999999\n\n',
  `restaurant_ID` char(10) NOT NULL COMMENT 'The ID to identify the Restaurant\nXX00000000-XX99999999\n\nXX:\n‘JP’ for Japan\n‘CH’ for Chinese\n‘TW’ for Taiwan\n‘IN’ for India\n‘VT’ for Vietnam\n\n',
...
CREATE TABLE `permission` (
  `permission_id` char(10) NOT NULL COMMENT 'The ID to identify the permission\n0000000000-9999999999\n\n',
...
CREATE TABLE `ppo_header` (
  `header_ID` char(10) NOT NULL COMMENT 'The ID of PPO header to identify different PPO Header\n0000000000-9999999999\n\n',
  ...
  `supplier_ID` char(10) NOT NULL COMMENT 'The ID to identify the supplier of PPO header\n0000000000-9999999999\n\n',
  `buyer_ID` char(10) NOT NULL COMMENT 'The ID to identify the buyer of PPO header\n0000000000-9999999999\n\n',
...
CREATE TABLE `ppo_lines` (
  `lines_ID` char(10) NOT NULL COMMENT 'The ID to identify the PPO lines\n0000000000-9999999999\n\n',
  `header_ID` char(10) NOT NULL COMMENT 'The ID to identify the PPO lines header\n0000000000-9999999999\n\n',
  `item_ID` char(10) NOT NULL COMMENT 'The ID to identify the PPO lines item\n0000000000-9999999999\n\n',
...
CREATE TABLE `price_breaks` (
  `price_break_ID` char(10) NOT NULL COMMENT 'The ID to identify each price breaks\n0000000000-9999999999\n\n',
...
CREATE TABLE `purchase_order_all` (
  `Purchase_order_ID` char(10) NOT NULL COMMENT 'The ID to identify the purchase order all \nCCCCBBYYYYMMDDSSSS\n\nCCCC - Company Code\nBB - Branch\nYYYY - Year\nMM - Month\nDD - Day\nSSSS - Sequence number per day\n\n',
  `BR_relase_ID` char(10) DEFAULT NULL COMMENT 'The ID to identify the release of purchase order all\n0000000000-9999999999\n\n',
  `SR_relase_ID` char(10) DEFAULT NULL COMMENT 'The ID to identify the release of purchase order all\n0000000000-9999999999\n\n',
  `SPO_relase_ID` char(10) DEFAULT NULL COMMENT 'The ID to identify the release of purchase order all\n0000000000-9999999999\n\n',
  `purchasers_request_ID` char(10) NOT NULL COMMENT 'The ID to identify the purchaser request of purchase order all\n0000000000-9999999999\n\n',
  `delivery_note_ID` char(10) DEFAULT NULL COMMENT 'The ID to identify the delivery note of purchase order all\n0000000000-9999999999\n\n',
...
CREATE TABLE `purchasers_request` (
  `purchasers_request_id` char(10) NOT NULL COMMENT 'The ID to identify the purchaser''s request\n0000000000-9999999999\n\n\n',
  `requestor_ID` char(10) NOT NULL COMMENT 'The ID to identify the requestor\n0000000000-9999999999\n\n',
  `restaurant_ID` char(10) NOT NULL COMMENT 'To represent different restaurants.\nXX00000000-XX99999999\n\nXX:\n‘JP’ for Japan\n‘CH’ for Chinese\n‘TW’ for Taiwan\n‘IN’ for India\n‘VT’ for Vietnam\n\n',
  `item_ID` char(10) NOT NULL COMMENT 'The ID to identify the item\n0000000000-9999999999\n\n',
  `qty` int NOT NULL COMMENT 'The quantity of  each item purchased.\n\n\n\n',
  `priority_id` char(10) NOT NULL COMMENT 'To represent who go first one\n1\n2\n\n',
  `status_ID` char(10) NOT NULL COMMENT 'The ID to identify the status\n0000000000-9999999999\n\n',
...
CREATE TABLE `request_line` (
  `line_ID` char(10) NOT NULL COMMENT 'The ID to identify the request line\n0000000000-9999999999\n\n',
  `purchaser_request_ID` char(10) NOT NULL COMMENT 'The ID to identify the purchaser request\n0000000000-9999999999\n\n',
  PRIMARY KEY (`line_ID`),
...
CREATE TABLE `restaurant` (
  `restaurant_ID` char(10) NOT NULL COMMENT 'The ID to identify each restaurant\nXX00000000-XX99999999\n\nXX:\n‘JP’ for Japan\n‘CH’ for Chinese\n‘TW’ for Taiwan\n‘IN’ for India\n‘VT’ for Vietnam\n‘FR’ for French\n\n',
  `name` varchar(30) NOT NULL COMMENT 'The name of each restaurant\n\n',
  `address_ID` char(20) NOT NULL COMMENT 'The ID to identify each address\nXX000000000000000000-XX999999999999999999\n\nXX:\n‘JP’ for Japan\n‘CH’ for Chinese\n‘TW’ for Taiwan\n‘IN’ for India\n‘VT’ for Vietnam\n‘FR’ for French\n\n',
...
CREATE TABLE `role_permission` (
  `role_id` char(10) NOT NULL COMMENT 'The ID to identify the \nrole\n0000000000-9999999999\n\n',
  `permission_id` char(10) NOT NULL COMMENT 'The ID to identify the permission\n0000000000-9999999999\n\n',
...
CREATE TABLE `schedule_release` (
  `release_ID` char(10) NOT NULL COMMENT 'The ID to identify the schedule release\n0000000000-9999999999\n\n',
  `header_ID` char(10) NOT NULL COMMENT 'The ID to identify the header of schedule release\n0000000000-9999999999\n\n',
...
CREATE TABLE `spo_header` (
  `header_ID` char(10) NOT NULL COMMENT 'The ID to identify the SPO header\n0000000000-9999999999\n\n',
  ...
  `supplier_ID` char(10) NOT NULL COMMENT 'The ID to identify the supplier of the SPO header\n0000000000-9999999999\n\n',
  `buyer_ID` char(10) NOT NULL COMMENT 'The ID to identify the buyer of SPO header\n0000000000-9999999999\n\n',
...
CREATE TABLE `spo_lines` (
  `lines_ID` char(10) NOT NULL COMMENT 'The ID of the SPO Lines that identify different SPO Lines\n0000000000-9999999999\n\n',
  `header_ID` char(10) NOT NULL COMMENT 'The ID of headers that identify different headers\n0000000000-9999999999\n\n',
  `item_ID` char(10) NOT NULL COMMENT 'The ID of the item\n0000000000-9999999999\n\n',
  ...
  `CPA_ID` char(10) NOT NULL COMMENT 'The ID of the CPA that identify different CPA\n0000000000-9999999999\n\n',
  `Quotation_ID` char(10) NOT NULL COMMENT 'The ID of the Quotation that identify different Quotation\n0000000000-9999999999\n\n',
  PRIMARY KEY (`lines_ID`),
...
CREATE TABLE `spo_release` (
  `release_ID` char(10) NOT NULL COMMENT 'The ID to identify the SPO release\n0000000000-9999999999\n\n',
  `header_ID` char(10) NOT NULL COMMENT 'The ID to identify header of SPO release\n0000000000-9999999999\n\n',
  PRIMARY KEY (`release_ID`),
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `status` (
  `status_ID` char(10) NOT NULL COMMENT 'The ID of the status\n0000000000-9999999999\n\n',
...
CREATE TABLE `supplier` (
  `supplier_ID` char(10) NOT NULL COMMENT 'The ID to identify each supplier\n0000000000-9999999999\n\n',
  ...
  `address_ID` char(20) NOT NULL COMMENT 'The ID to identify each address.\nXX000000000000000000-XX999999999999999999\n\nXX :\n\n‘US’ for user\n‘SU’ for supplier\n‘WH’ for warehouse\n‘RE’ for restaurant\n\n',
  `contact_person_ID` char(10) NOT NULL COMMENT 'The ID to identify contact person\n0000000000-9999999999\n\n',
  `remarks` varchar(50) DEFAULT NULL COMMENT 'The remark that they have to add \n\n\n\n',
...
CREATE TABLE `supplier_contact_person` (
  `contact_person_ID` char(10) NOT NULL COMMENT 'The ID of the contact person\n0000000000-9999999999\n\n',
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user` (
  `user_id` char(10) NOT NULL COMMENT 'The ID to identify each user.',
  ...
  `role_id` char(10) DEFAULT NULL COMMENT 'The ID to identify role',
...
CREATE TABLE `warehouse` (
  `warehouse_ID` char(10) NOT NULL COMMENT 'The ID to identify the warehouse\n0000000000-9999999999\n\n',
  `name` varchar(30) NOT NULL COMMENT 'The name of warehouse',
  `address_id` char(20) NOT NULL COMMENT 'The ID to identify the address of warehouse\nXX000000000000000000-XX999999999999999999\nXX =\n‘KW’ for Kowloon\n‘NT’ for New Territories\n‘HK’ for Hong Kong Island\n\n',
...
CREATE TABLE `warehouse_item` (
  `warehouse_ID` char(10) NOT NULL COMMENT 'The ID to identify the warehouse\n0000000000-9999999999\n\n',
  `item_ID` char(10) NOT NULL COMMENT 'The ID to identify each item inside the warehouse\n0000000000-9999999999\n\n',
...
CREATE TABLE `warehousedispatchinstruction` (
  `Instruction_ID` char(10) NOT NULL COMMENT 'The ID to identify different DispatchInstruction\n0000000000-9999999999\n\n',
  `warehouse_ID` char(10) NOT NULL COMMENT 'The ID to identify the purchase order\n0000000000-9999999999\n\n',
  `handler` char(10) NOT NULL COMMENT 'The ID to identify the handler\n0000000000-9999999999\n\n',
  `remark` varchar(30) DEFAULT NULL COMMENT 'The remark that they have to add \n\n\n\n',
  `itemID` char(10) NOT NULL COMMENT 'The ID to identify the item\n0000000000-9999999999\n\n',
  `status_id` char(10) NOT NULL COMMENT 'The ID to identify the status\n0000000000-9999999999\n\n',
  `Purchasers_Request_id` char(10) NOT NULL COMMENT 'The ID to identify the purchasers request\n0000000000-9999999999\n\n',
