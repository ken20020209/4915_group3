...
namespace ITP4915_group3_project.Restaurant.stock
{
    public partial class check : UserControl
    {
        ...
        private void dataTable_restaurant_stock_searchKryptonDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            detail stockDetail = new detail(this,int.Parse(dataTable_restaurant_stock_searchKryptonDataGridView.Rows[e.RowIndex].Cells["dataGridViewTextBoxColumn_item_ID"].Value.ToString()),restaurant.restaurant_ID);
        }
